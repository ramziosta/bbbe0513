...
const Home = () => {
  ...
  return (
    <>
      ...
      <br />
      <Link to="/editor" style={{color:"black"}}>Go to the Editor page</Link>
      <br />
      <Link to="/admin" style={{color:"black"}}>Go to the Admin page</Link>
      <br />
      <Link to="/lounge" style={{color:"black"}}>Go to the Lounge</Link>
      <br />
      <Link to="/linkpage" style={{color:"black"}}>Go to the link page</Link>
      </div>
          ...
          <div className="modal-dialog">
            ...
            >
              ...
              <div className="modal-header" style={{ fontWeight: "bold" }}>
                ...
                >
                  Open a new <span style={{ color: "rgb(0, 0, 254)" }}>B</span>
                  ad
                ...
                <button
                  type="button"
                  className="btn btn-secondary close text-white fs-2"
              ...
              >
                ...
                <ol>
                  ...
                  <br />
                  <li>
                    when you login : you will land on the dashboard where you
                    get a summary of your account, last 4 digits of your account
                  ...
                  <br />
                  <li>
                    logout and login with your account email and password.
                  </li>
                </ol>
              </div>
            </div>
